...
@section('content')
  ...
  @slot('subtitle') Manage Kelas @endslot
  @endcomponent
      ...
      <div class="box-header with-border">
        ...
        <div class="box-tools pull-right" style="margin-top:0px;">
          <button type="button" href="#" class="btn btn-sm bg-blue"
            data-toggle="modal" data-target="#kelas" onclick="clearform()">
...
@section('javascript')
  <script>
    function clearform() {
      var modal = $('#kelas'),
          form  = modal.find('form[name="kelas"]')
    ...
    $('form[name="kelas"]').on('submit', function(e) {
      var form   = $(this),
          modal  = $('#kelas'),
    ...
    function edit(id) {
      ...
      modal.find('.modal-title').text('Ubah Kelas')
      form.attr('action', '{{ route('kelas.index') }}/' + id)
