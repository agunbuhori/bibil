<div class="modal fade" id="kelas" data-backdrop="static">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <form name="kelas" action="{{ route('kelas.store') }}" method="post">
        @csrf
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" id="nama_kelas" name="nama_kelas" class="form-control" placeholder="Nama Kelas" required>
          </div>
          <div class="form-group">
