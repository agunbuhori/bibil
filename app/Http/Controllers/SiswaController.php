...
class SiswaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $siswa->appends($request->only('keyword', 'limit'));

        $view = ($request->ajax()) ? 'list' : 'index';
        
        return view('pages.siswa.' . $view, compact('siswa', 'request'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $user = $this->createUser($request, 'siswa');

        return $this->createSiswa($user->id, $request);
    }
